...
$(document).ready(() => {
    ...
    let navTemplates = $("#userHistory-template").html();
    let compilednavTemplates = Handlebars.compile(navTemplates);
    $.ajax("/partials/handlebars-user-history-partial.html").done((navDetail) => {
        $("body").append(navDetail);
        Handlebars.registerPartial("userHistoryPartial", $("#user-history-detail-template").html());
        $('#userHistory-container').html(compilednavTemplates(res));
